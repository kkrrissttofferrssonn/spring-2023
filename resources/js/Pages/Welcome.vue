                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    ...
                    >
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Laravel sdsssssssssssssssssssshas wonderful documentation covering every aspect of the framework. Whether you
                    ...
                    >
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Laravel Newssssssssssssss is a community driven portal and newsletter aggregating all of the latest
